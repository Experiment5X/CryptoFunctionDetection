...
#define FP_METHD "INTEG;COMBA;COMBA;MONTY;EXGCD;SLIDE"
...
/** Error mode none. */
#define ERRMO_NONE     1
/** Error mode separate context. */
#define ERRMO_SEPCTX   2
/** Error mode separate thread local context. */
#define ERRMO_SPTHREAD 3

/** Chosen error handling mode. */
#define ERRMO    ERRMO_SPTHREAD
