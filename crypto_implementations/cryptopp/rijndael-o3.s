...
LBB6_21:
	...
	add	r9, -16
	lea	r8, [rbx + 4*rcx]
	mov	r11, qword ptr [rip + __ZN8CryptoPP8Rijndael4Base4rconE@GOTPCREL]
	xor	edi, edi
...
LBB6_23:                                
	...
	xor	edx, dword ptr [rbx + rdi]
	xor	edx, ecx
	mov	dword ptr [rax + rdi - 12], edx
	xor	edx, dword ptr [rbx + rdi + 4]
	mov	dword ptr [rax + rdi - 8], edx
	xor	edx, dword ptr [rbx + rdi + 8]
	mov	dword ptr [rax + rdi - 4], edx
	xor	edx, dword ptr [rbx + rdi + 12]
	mov	dword ptr [rax + rdi], edx
	cmp	r9, rdi
	je	LBB6_30

	add	r11, 4
	mov	ecx, dword ptr [rbx + rdi + 36]
	xor	ecx, dword ptr [rbx + rdi + 16]
	mov	dword ptr [rbx + rdi + 40], ecx
	xor	ecx, dword ptr [rbx + rdi + 20]
	mov	dword ptr [rbx + rdi + 44], ecx
	add	rdi, r12
	jmp	LBB6_23
LBB6_25:
	lea	r14, [rbx + 4*r14]
	...
	xor	edi, edi
	mov	r11, qword ptr [rip + __ZN8CryptoPP8Rijndael4Base2SeE@GOTPCREL]
	jmp	LBB6_26
	.p2align	4, 0x90
LBB6_28:                                
	add	r10, 4
...
LBB6_26:                                
	...
	xor	edx, dword ptr [rbx + rdi]
	xor	edx, ecx
	mov	dword ptr [r14 + rdi - 12], edx
	xor	edx, dword ptr [rbx + rdi + 4]
	mov	dword ptr [r14 + rdi - 8], edx
	xor	edx, dword ptr [rbx + rdi + 8]
	mov	dword ptr [r14 + rdi - 4], edx
	xor	edx, dword ptr [rbx + rdi + 12]
	...
	xor	eax, esi
	xor	eax, ecx
	mov	dword ptr [rbx + rdi + 48], eax
	xor	eax, dword ptr [rbx + rdi + 20]
	mov	dword ptr [rbx + rdi + 52], eax
	xor	eax, dword ptr [rbx + rdi + 24]
	mov	dword ptr [rbx + rdi + 56], eax
	xor	eax, dword ptr [rbx + rdi + 28]
	mov	dword ptr [rbx + rdi + 60], eax
	jmp	LBB6_28
LBB6_30:
	mov	rbx, qword ptr [rbp - 48] 
	lea	rdi, [rbx + 8]
...
LBB6_41:                                
	...
	movzx	ecx, bl
	shr	rbx, 24
	movzx	ebx, byte ptr [r11 + rbx]
	shr	eax, 16
	movzx	eax, al
	movzx	eax, byte ptr [r11 + rax]
	mov	edi, dword ptr [r10 + 8*rax + 1]
	xor	edi, dword ptr [r10 + 8*rbx + 4]
	mov	r9d, r9d
	movzx	eax, byte ptr [r11 + rsi]
	xor	edi, dword ptr [r10 + 8*rax + 2]
	...
	xor	ecx, dword ptr [r10 + 8*rsi + 4]
	movzx	esi, ah
	movzx	esi, byte ptr [r11 + rsi]
	xor	ecx, dword ptr [r10 + 8*rsi + 2]
	movzx	eax, al
	movzx	eax, byte ptr [r11 + rax]
	xor	ecx, dword ptr [r10 + 8*rax + 3]
	mov	dword ptr [r13 + 4*r8 + 4], ecx
	mov	dword ptr [r13 + 4*rbx], edi
	mov	eax, dword ptr [r13 + 4*r8 + 8]
	mov	ecx, eax
	mov	rsi, rax
	shr	rsi, 24
	movzx	esi, byte ptr [r11 + rsi]
	...
	movzx	ecx, cl
	movzx	ecx, byte ptr [r11 + rcx]
	mov	edi, dword ptr [r10 + 8*rcx + 1]
	xor	edi, dword ptr [r10 + 8*rsi + 4]
	movzx	ecx, ah
	movzx	ecx, byte ptr [r11 + rcx]
	xor	edi, dword ptr [r10 + 8*rcx + 2]
	movzx	eax, al
	movzx	eax, byte ptr [r11 + rax]
	xor	edi, dword ptr [r10 + 8*rax + 3]
	lea	ebx, [r9 + 2]
	mov	edx, dword ptr [r13 + 4*rbx]
	mov	ecx, edx
	movzx	esi, dh
	mov	rax, rdx
	shr	rax, 24
	...
	movzx	eax, dl
	movzx	edx, byte ptr [r11 + rsi]
	xor	ecx, dword ptr [r10 + 8*rdx + 2]
	movzx	eax, byte ptr [r11 + rax]
	xor	ecx, dword ptr [r10 + 8*rax + 3]
	mov	dword ptr [r13 + 4*r8 + 8], ecx
	mov	dword ptr [r13 + 4*rbx], edi
	...
	movzx	eax, byte ptr [r11 + rax]
	xor	ecx, dword ptr [r10 + 8*rax + 3]
	mov	dword ptr [r13 + 4*r8 + 12], ecx
	mov	dword ptr [r13 + 4*rbx], edi
	add	r8, 4
	add	r9d, -4
	jmp	LBB6_41
LBB6_43:
	mov	dword ptr [r13 + 4*r8], edi
	mov	ebx, dword ptr [r13 + 4*r8 + 4]
	mov	eax, ebx
	movzx	ecx, bh
	movzx	edx, bl
