...
*
* Target
*  - Compiler: clang++ -fstack-protector -m64 -pthread -stdlib=libc++ -std=c++17 -D_REENTRANT -O3
*  - Arch: x86_64
*  - OS: macos
*/
...
#define BOTAN_VERSION_VC_REVISION "git:631e22b44ec9d3cf7880182c965843022f75bd0a"
