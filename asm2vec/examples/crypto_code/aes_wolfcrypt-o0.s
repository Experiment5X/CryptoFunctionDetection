...
LBB1_12:                                
	...
	mov	eax, esi
	lea	rdi, [rip + _Te]
	mov	esi, dword ptr [rdi + 4*rax + 2048]
	and	esi, -16777216
	xor	ecx, esi
	...
	mov	r8d, r8d
	mov	eax, r8d
	mov	r8d, dword ptr [rdi + 4*rax + 3072]
	and	r8d, 16711680
	xor	ecx, r8d
	...
	mov	r10d, r10d
	mov	eax, r10d
	mov	r10d, dword ptr [rdi + 4*rax + 1024]
	and	r10d, 255
	xor	ecx, r10d
...
LBB1_33:                                
	...
	mov	eax, edx
	lea	rsi, [rip + _Te]
	mov	edx, dword ptr [rsi + 4*rax + 1024]
	and	edx, 255
	mov	edx, edx
	mov	eax, edx
	lea	rdi, [rip + _Td]
	...
	mov	r9d, r9d
	mov	eax, r9d
	mov	r9d, dword ptr [rsi + 4*rax + 1024]
	and	r9d, 255
	mov	r9d, r9d
	mov	eax, r9d
	xor	edx, dword ptr [rdi + 4*rax + 1024]
	mov	rax, qword ptr [rbp - 104]
	...
	mov	r10d, r10d
	mov	eax, r10d
	mov	r10d, dword ptr [rsi + 4*rax + 1024]
	and	r10d, 255
	mov	r10d, r10d
	mov	eax, r10d
	xor	edx, dword ptr [rdi + 4*rax + 2048]
	mov	rax, qword ptr [rbp - 104]
	...
	mov	r11d, r11d
	mov	eax, r11d
	mov	r11d, dword ptr [rsi + 4*rax + 1024]
	and	r11d, 255
	mov	r11d, r11d
	mov	eax, r11d
	...
	mov	r14d, r14d
	mov	eax, r14d
	mov	r14d, dword ptr [rsi + 4*rax + 1024]
	and	r14d, 255
	mov	r14d, r14d
	mov	eax, r14d
	xor	r11d, dword ptr [rdi + 4*rax + 1024]
	mov	rax, qword ptr [rbp - 104]
	...
	mov	r15d, r15d
	mov	eax, r15d
	mov	r15d, dword ptr [rsi + 4*rax + 1024]
	and	r15d, 255
	mov	r15d, r15d
	mov	eax, r15d
	xor	r11d, dword ptr [rdi + 4*rax + 2048]
	mov	rax, qword ptr [rbp - 104]
	...
	mov	r12d, r12d
	mov	eax, r12d
	mov	r12d, dword ptr [rsi + 4*rax + 1024]
	and	r12d, 255
	mov	r12d, r12d
	mov	eax, r12d
	xor	r11d, dword ptr [rdi + 4*rax + 3072]
	mov	rax, qword ptr [rbp - 104]
	...
	mov	ecx, ecx
	mov	eax, ecx
	mov	ecx, dword ptr [rsi + 4*rax + 1024]
	and	ecx, 255
	mov	ecx, ecx
	mov	eax, ecx
	xor	r12d, dword ptr [rdi + 4*rax + 1024]
	mov	rax, qword ptr [rbp - 104]
	mov	ecx, dword ptr [rax + 8]
	shr	ecx, 8
	...
	mov	ecx, ecx
	mov	eax, ecx
	xor	r12d, dword ptr [rdi + 4*rax + 2048]
	mov	rax, qword ptr [rbp - 104]
	mov	ecx, dword ptr [rax + 8]
	shr	ecx, 0
	...
	mov	ecx, ecx
	mov	eax, ecx
	xor	r12d, dword ptr [rdi + 4*rax + 3072]
	mov	rax, qword ptr [rbp - 104]
...
_wc_AesEncrypt:                         
	...
	mov	r8d, r8d
	mov	edx, r8d
	xor	ecx, dword ptr [rsi + 4*rdx + 1024]
	...
	mov	ebx, ebx
	mov	edx, ebx
	xor	r10d, dword ptr [rsi + 4*rdx + 1024]
	...
	mov	r14d, r14d
	mov	edx, r14d
	xor	r10d, dword ptr [rsi + 4*rdx + 2048]
	...
	mov	r15d, r15d
	mov	edx, r15d
	xor	r10d, dword ptr [rsi + 4*rdx + 3072]
	mov	rdx, qword ptr [rbp - 112]
	xor	r10d, dword ptr [rdx + 20]
	...
	mov	r13d, r13d
	mov	edx, r13d
	xor	r15d, dword ptr [rsi + 4*rdx + 1024]
	...
	mov	eax, eax
	mov	edx, eax
	xor	r15d, dword ptr [rsi + 4*rdx + 2048]
	...
	mov	eax, eax
	mov	edx, eax
	xor	r15d, dword ptr [rsi + 4*rdx + 3072]
	mov	rdx, qword ptr [rbp - 112]
	...
	xor	r15d, dword ptr [rsi + 4*rdx + 3072]
	mov	rdx, qword ptr [rbp - 112]
	xor	r15d, dword ptr [rdx + 44]
	mov	dword ptr [rbp - 80], r15d
	mov	eax, dword ptr [rbp - 68]
	shr	eax, 24
	...
	xor	r15d, dword ptr [rsi + 4*rdx + 3072]
	mov	rdx, qword ptr [rbp - 112]
	xor	r15d, dword ptr [rdx + 156]
	mov	dword ptr [rbp - 96], r15d
	cmp	dword ptr [rbp - 100], 5
	jbe	LBB5_4
...
LBB5_4:
	...
	mov	ecx, esi
	lea	rdx, [rip + _Te]
	mov	esi, dword ptr [rdx + 4*rcx + 2048]
	and	esi, -16777216
	mov	edi, dword ptr [rbp - 88]
	shr	edi, 16
	...
	mov	r8d, r8d
	mov	ecx, r8d
	mov	r8d, dword ptr [rdx + 4*rcx + 3072]
	and	r8d, 16711680
	xor	esi, r8d
	mov	r8d, dword ptr [rbp - 92]
	shr	r8d, 8
	...
	mov	r10d, r10d
	mov	ecx, r10d
	mov	r10d, dword ptr [rdx + 4*rcx + 1024]
	and	r10d, 255
	xor	esi, r10d
	mov	rcx, qword ptr [rbp - 112]
	...
	mov	r10d, r10d
	mov	ecx, r10d
	mov	r10d, dword ptr [rdx + 4*rcx + 2048]
	and	r10d, -16777216
	mov	r11d, dword ptr [rbp - 92]
	shr	r11d, 16
	...
	mov	ebx, ebx
	mov	ecx, ebx
	mov	ebx, dword ptr [rdx + 4*rcx + 3072]
	and	ebx, 16711680
	xor	r10d, ebx
	mov	ebx, dword ptr [rbp - 96]
	shr	ebx, 8
	...
	mov	r15d, r15d
	mov	ecx, r15d
	mov	r15d, dword ptr [rdx + 4*rcx + 1024]
	and	r15d, 255
	xor	r10d, r15d
	mov	rcx, qword ptr [rbp - 112]
	xor	r10d, dword ptr [rcx + 4]
	mov	dword ptr [rbp - 72], r10d
	mov	r10d, dword ptr [rbp - 92]
	shr	r10d, 24
	...
	mov	r15d, r15d
	mov	ecx, r15d
	mov	r15d, dword ptr [rdx + 4*rcx + 2048]
	and	r15d, -16777216
	mov	r12d, dword ptr [rbp - 96]
	shr	r12d, 16
	...
	mov	r13d, r13d
	mov	ecx, r13d
	mov	r13d, dword ptr [rdx + 4*rcx + 3072]
	and	r13d, 16711680
	xor	r15d, r13d
	mov	r13d, dword ptr [rbp - 84]
	shr	r13d, 8
	...
	mov	eax, eax
	mov	ecx, eax
	mov	eax, dword ptr [rdx + 4*rcx + 1024]
	and	eax, 255
	xor	r15d, eax
	mov	rcx, qword ptr [rbp - 112]
	xor	r15d, dword ptr [rcx + 8]
	mov	dword ptr [rbp - 76], r15d
	mov	eax, dword ptr [rbp - 96]
	shr	eax, 24
	...
	mov	eax, eax
	mov	ecx, eax
	mov	eax, dword ptr [rdx + 4*rcx + 3072]
	and	eax, 16711680
	xor	r15d, eax
	mov	eax, dword ptr [rbp - 88]
	shr	eax, 8
