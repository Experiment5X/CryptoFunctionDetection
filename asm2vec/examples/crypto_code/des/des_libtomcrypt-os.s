...
LBB12_3:                                
	...
	add	ecx, ecx
	mov	dword ptr [rbp + 4*r13 - 304], r14d
	mov	dword ptr [rbp + 4*rcx - 304], r14d
	lea	rax, [rip + _totrot]
...
LBB12_8:                                
	...
	cmp	byte ptr [rbp + rax - 432], 0
	je	LBB12_10

	or	r8d, dword ptr [rdx + r12]
	mov	dword ptr [rbp + 4*rcx - 304], r8d
LBB12_10:                               
	movzx	eax, byte ptr [rdi + 24]
	cmp	byte ptr [rbp + rax - 432], 0
	je	LBB12_12

	or	ebx, dword ptr [rdx + r12]
...
LBB12_12:                               
	...
	mov	edi, 63
LBB12_15:                               
	mov	esi, dword ptr [rbp + 8*rax - 304]
	mov	ebx, dword ptr [rbp + 8*rax - 300]
	mov	edx, esi
	shl	edx, 6
	and	edx, r9d
	mov	ecx, esi
	...
	and	ecx, edi
	or	ecx, edx
	mov	dword ptr [rbp + 8*rax - 176], ecx
	mov	ecx, esi
	shl	ecx, 12
	and	ecx, r9d
	and	esi, edi
	...
	or	ebx, esi
	or	ebx, ecx
	mov	dword ptr [rbp + 8*rax - 172], ebx
	inc	rax
	cmp	eax, 16
	jne	LBB12_15
...
_desfunc:                               
	...
	shr	rax, 8
	and	rax, r10
	mov	r9, qword ptr [rcx + 8*rax + 2048]
	xor	r9, qword ptr [rcx + 8*rdx]
	mov	rdx, rbx
	shr	rdx, 13
	mov	r8d, 2040
	and	rdx, r8
	xor	r9, qword ptr [rdx + rcx + 4096]
	shr	rbx, 24
	xor	r9, qword ptr [rcx + 8*rbx + 6144]
	mov	qword ptr [rbp - 48], rdi 
	mov	ebx, dword ptr [rdi + 4]
	mov	rdx, rbx
	and	rdx, r10
	xor	r9, qword ptr [rcx + 8*rdx + 8192]
	mov	rdx, rbx
	shr	rdx, 8
	and	rdx, r10
	xor	r9, qword ptr [rcx + 8*rdx + 10240]
	mov	rdx, rbx
	shr	rdx, 13
	and	rdx, r8
	xor	r9, qword ptr [rdx + rcx + 12288]
	shr	rbx, 24
	xor	r9, qword ptr [rcx + 8*rbx + 14336]
	mov	rax, r9
	shr	rax, 32
	xor	r11d, r11d
	mov	r8d, 63
...
LBB13_1:                                
	mov	ecx, r9d
	rol	ecx, 28
	xor	ecx, dword ptr [rsi + r11]
	mov	edi, ecx
	and	edi, r8d
	lea	rdx, [rip + _SP7]
	xor	eax, dword ptr [rdx + 4*rdi]
	mov	edi, ecx
	shr	edi, 8
	and	edi, r8d
	...
	mov	ebx, eax
	rol	ebx, 28
	xor	ebx, dword ptr [rsi + r11 + 8]
	mov	edi, ebx
	and	edi, r8d
	xor	r9d, dword ptr [rdx + 4*rdi]
	mov	edi, ebx
	shr	edi, 8
	and	edi, r8d
	xor	r9d, dword ptr [r14 + 4*rdi]
	mov	edi, ebx
	shr	edi, 16
	and	edi, r8d
	shr	ebx, 24
	...
	lea	rdx, [rip + _SP3]
	xor	r9d, dword ptr [rdx + 4*rdi]
	mov	edx, dword ptr [rsi + r11 + 12]
	xor	edx, eax
	xor	r9d, dword ptr [r12 + 4*rbx]
	mov	edi, edx
	and	edi, r8d
	xor	r9d, dword ptr [rcx + 4*rdi]
	mov	edi, edx
	shr	edi, 8
	and	edi, r8d
	xor	r9d, dword ptr [r13 + 4*rdi]
	mov	edi, edx
	shr	edi, 16
	and	edi, r8d
	xor	r9d, dword ptr [r10 + 4*rdi]
	shr	edx, 24
	and	edx, r8d
	...
	shr	esi, 8
	and	esi, edi
	mov	rsi, qword ptr [rdx + 8*rsi + 2048]
	xor	rsi, qword ptr [rdx + 8*rbx]
	mov	ecx, eax
	shr	ecx, 16
	and	ecx, edi
	xor	rsi, qword ptr [rdx + 8*rcx + 4096]
	shr	eax, 24
	xor	rsi, qword ptr [rdx + 8*rax + 6144]
	mov	eax, r9d
	and	eax, edi
	xor	rsi, qword ptr [rdx + 8*rax + 8192]
	mov	eax, r9d
	shr	eax, 8
	and	eax, edi
	xor	rsi, qword ptr [rdx + 8*rax + 10240]
	mov	eax, r9d
	shr	eax, 16
	and	eax, edi
	xor	rsi, qword ptr [rdx + 8*rax + 12288]
	shr	r9d, 24
	xor	rsi, qword ptr [rdx + 8*r9 + 14336]
