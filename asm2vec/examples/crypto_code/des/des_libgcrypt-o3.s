...
LBB0_6:
	...
	pshufd	xmm0, xmm0, 78          
	movdqu	xmmword ptr [rbx + 128], xmm0
	movdqu	xmm0, xmmword ptr [rbx + 96]
	pshufd	xmm0, xmm0, 78          
	movdqu	xmmword ptr [rbx + 144], xmm0
	movdqu	xmm0, xmmword ptr [rbx + 80]
	pshufd	xmm0, xmm0, 78          
	movdqu	xmmword ptr [rbx + 160], xmm0
	movdqu	xmm0, xmmword ptr [rbx + 64]
	pshufd	xmm0, xmm0, 78          
	movdqu	xmmword ptr [rbx + 176], xmm0
	movdqu	xmm0, xmmword ptr [rbx]
	movdqu	xmm1, xmmword ptr [rbx + 16]
	movdqu	xmm2, xmmword ptr [rbx + 32]
	movdqu	xmm3, xmmword ptr [rbx + 48]
	pshufd	xmm3, xmm3, 78          
	movdqu	xmmword ptr [rbx + 192], xmm3
	pshufd	xmm2, xmm2, 78          
	movdqu	xmmword ptr [rbx + 208], xmm2
	pshufd	xmm1, xmm1, 78          
	movdqu	xmmword ptr [rbx + 224], xmm1
	pshufd	xmm0, xmm0, 78          
	movdqu	xmmword ptr [rbx + 240], xmm0
LBB0_7:
	mov	rdi, r14
	call	_is_weak_key
	mov	ebx, eax
...
_selftest:                              
	...
	mov	r15d, 64
	mov	r14, qword ptr [rip + __gcry_no_fips_mode_required@GOTPCREL]
	lea	rbx, [rbp - 848]
	lea	r12, [rbp - 864]
	lea	r13, [rbp - 64]
	jmp	LBB9_1
...
LBB9_12:                                
	...
	pshufd	xmm0, xmmword ptr [rbp - 736], 78 
	movdqa	xmmword ptr [rbp - 720], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 752], 78 
	movdqa	xmmword ptr [rbp - 704], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 768], 78 
	movdqa	xmmword ptr [rbp - 688], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 784], 78 
	movdqa	xmmword ptr [rbp - 672], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 800], 78 
	movdqa	xmmword ptr [rbp - 656], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 816], 78 
	movdqa	xmmword ptr [rbp - 640], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 832], 78 
	movdqa	xmmword ptr [rbp - 624], xmm0
	pshufd	xmm0, xmmword ptr [rbp - 848], 78 
