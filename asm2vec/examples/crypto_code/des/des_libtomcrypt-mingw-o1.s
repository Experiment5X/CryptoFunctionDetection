...
L24:
	...
	jmp	L35
L26:
	movzx	ebx, BYTE PTR [esp+172+eax]
...
L28:
	cmp	eax, 27
	ja	L26
	movzx	ebx, BYTE PTR [esp+200+eax]
	mov	BYTE PTR [ecx+eax], bl
	jmp	L27
L45:
...
L34:
	...
	cmp	BYTE PTR [esp+144+edx], 0
	je	L32
	mov	edx, DWORD PTR _bigbyte[0+eax*4]
	or	DWORD PTR [esp+256+ebx*4], edx
L32:
	movzx	edx, BYTE PTR _pc2[eax+24]
	cmp	BYTE PTR [esp+144+edx], 0
	je	L33
	mov	edx, DWORD PTR _bigbyte[0+eax*4]
	or	DWORD PTR [esp+256+esi*4], edx
	jmp	L33
L47:
	add	ebp, 1
	sub	DWORD PTR [esp], 2
...
L25:
	lea	esi, [ebx+1]
	mov	DWORD PTR [esp+256+esi*4], 0
	mov	DWORD PTR [esp+256+ebx*4], 0
	movzx	edi, BYTE PTR _totrot[ebp]
	lea	edx, [edi+28]
	mov	eax, edi
	lea	ecx, [esp+144]
	sub	ecx, edi
...
L48:
	mov	ecx, 0
L36:
	mov	esi, DWORD PTR [esp+256+ecx*8]
	mov	ebx, DWORD PTR [esp+260+ecx*8]
	mov	edx, esi
	sal	edx, 6
	and	edx, 1056964608
	mov	eax, esi
	...
	and	eax, 63
	or	edx, eax
	mov	DWORD PTR [esp+16+ecx*8], edx
	mov	eax, esi
	sal	eax, 12
	and	eax, 1056964608
	sal	esi, 16
	...
	and	ebx, 16128
	or	eax, ebx
	mov	DWORD PTR [esp+20+ecx*8], eax
	add	ecx, 1
	cmp	ecx, 16
	jne	L36
	lea	esi, [esp+16]
...
L116:
	...
	jne	L105
L115:
	mov	BYTE PTR [esp+4304+eax], 0
	mov	BYTE PTR [esp+4320+eax], 0
	add	eax, 1
	cmp	eax, 8
	jne	L115
	mov	ebx, 1000
