...
.LBB12_114:                             
	mov	ecx, dword ptr [rsp - 84]
	movzx	esi, byte ptr [rcx + pc1]
	mov	ebx, esi
	and	ebx, 7
	shr	rsi, 3
	mov	rax, qword ptr [rsp + 24] 
	movzx	esi, byte ptr [rax + rsi]
	mov	ebx, dword ptr [4*rbx + bytebit]
	mov	ebp, ebx
	not	ebp
	not	esi
	or	esi, ebp
	not	esi
	cmp	esi, ebx
	sete	byte ptr [rsp + rcx + 96]
	xor	ecx, ecx
	sub	ecx, dword ptr [rsp - 84]
	mov	esi, 1
	sub	esi, ecx
	mov	r12d, 1883327219
	jmp	.LBB12_1
...
.LBB12_118:                             
	...
	lea	r11d, [rcx + rcx - 1201130800]
	mov	r12d, -469470447
	jmp	.LBB12_1
.LBB12_113:                             
	movzx	ecx, byte ptr [rsp - 99]
	test	cl, cl
	mov	r12d, 1279775971
	mov	eax, -751144117
	cmovne	r12d, eax
...
_desfunc:
	...
	movzx	esi, ch  
	mov	rsi, qword ptr [8*rsi + des_ip+2048]
	mov	rdi, rsi
	not	rdi
	and	rdi, rdx
	not	rdx
	...
	shr	esi, 16
	movzx	esi, sil
	mov	rbx, qword ptr [8*rsi + des_ip+4096]
	mov	rdi, rdx
	not	rdi
	movabs	rbp, 6009270914935685288
	and	rdi, rbp
	mov	rsi, rbx
	not	rsi
	and	rsi, rbp
	...
	mov	rdx, rbp
	not	rdx
	movabs	rsi, 5449163044830543060
	and	rdx, rsi
	mov	rdi, rcx
	not	rdi
	and	rdi, rsi
	...
	xor	ecx, -256
	and	ecx, eax
	mov	rdx, qword ptr [8*rcx + des_ip+8192]
	mov	rcx, rsi
	not	rcx
	and	rcx, rdx
	not	rdx
	...
	xor	esi, 65280
	and	esi, edx
	mov	rbp, qword ptr [8*rsi + des_ip+12288]
	mov	rsi, rcx
	not	rsi
	movabs	rdi, -2867208899221555243
	and	rsi, rdi
	mov	rdx, rbp
	not	rdx
	and	rdx, rdi
	...
	xor	rdi, rcx
	shr	eax, 24
	mov	rax, qword ptr [8*rax + des_ip+14336]
	mov	rcx, rdi
	not	rcx
	movabs	r14, 5683626233522600544
	and	rcx, r14
	mov	rdx, rax
	not	rdx
	and	rdx, r14
...
.LBB13_12:                              
	...
	xor	eax, -64
	and	eax, esi
	mov	edx, dword ptr [4*rax + SP7]
	mov	eax, esi
	shr	eax, 8
	and	eax, 63
	mov	eax, dword ptr [4*rax + SP5]
	mov	ecx, esi
	shr	ecx, 16
	and	ecx, 63
	mov	qword ptr [rsp - 24], r8 
	mov	r8d, dword ptr [4*rcx + SP3]
	shr	esi, 24
	mov	ecx, esi
	xor	ecx, 192
	and	ecx, esi
	...
	xor	edi, -64
	and	edi, esi
	mov	r10d, dword ptr [4*rdi + SP8]
	mov	edi, esi
	shr	edi, 8
	mov	ebp, edi
	xor	ebp, 16777152
	and	ebp, edi
	mov	r9d, dword ptr [4*rbp + SP6]
	mov	edi, esi
	shr	edi, 16
	and	edi, 63
	mov	ebp, dword ptr [4*rdi + SP4]
	shr	esi, 24
	and	esi, 63
	mov	r13d, dword ptr [4*rsi + SP2]
	mov	esi, eax
	not	esi
	mov	edi, edx
	not	edi
	...
	xor	eax, -64
	and	eax, ecx
	mov	r11d, dword ptr [4*rax + SP7]
	mov	eax, ecx
	shr	eax, 8
	mov	edx, eax
	xor	edx, 16777152
	and	edx, eax
	mov	esi, dword ptr [4*rdx + SP5]
	mov	eax, ecx
	shr	eax, 16
	mov	edx, eax
	xor	edx, 65472
	and	edx, eax
	mov	eax, dword ptr [4*rdx + SP3]
	shr	ecx, 24
	mov	edx, ecx
	xor	edx, 192
	and	edx, ecx
	mov	r13d, dword ptr [4*rdx + SP1]
	mov	ebp, dword ptr [rsp - 72]
	lea	rcx, [r12 + 16]
	mov	qword ptr [rsp - 8], rcx
...
.LBB13_10:
	...
	xor	edx, 16776960
	and	edx, ecx
	mov	rcx, qword ptr [8*rdx + des_fp+2048]
	mov	rdx, rcx
	not	rdx
	and	rdx, rax
	not	rax
	...
	shr	ecx, 16
	movzx	ecx, cl
	mov	rcx, qword ptr [8*rcx + des_fp+4096]
	mov	rdx, rax
	not	rdx
	and	rdx, rcx
	not	rcx
	...
	mov	eax, dword ptr [rsp - 68]
	shr	eax, 24
	mov	rdx, qword ptr [8*rax + des_fp+6144]
	mov	rax, rcx
	not	rax
	and	rax, rdx
	not	rdx
	...
	xor	ecx, -256
	and	ecx, eax
	mov	rax, qword ptr [8*rcx + des_fp+8192]
	mov	rcx, rdx
	not	rcx
	and	rcx, rax
	not	rax
	...
	mov	rsi, rax
	not	rsi
	movabs	rcx, 8245633568062399752
	and	rsi, rcx
	mov	rdi, rdx
	not	rdi
	and	rdi, rcx
	...
	mov	rdx, rcx
	not	rdx
	movabs	rsi, 4994470727809691217
	and	rdx, rsi
	mov	rdi, rax
	not	rdi
	and	rdi, rsi
