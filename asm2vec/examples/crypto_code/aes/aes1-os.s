...
_keyExpansion:                          
	...
	xorps	xmm0, xmm0
	lea	r12, [rbp - 208]
	movaps	xmmword ptr [r12 + 144], xmm0
	movaps	xmmword ptr [r12 + 128], xmm0
...
LBB1_1:                                 
	...
	mov	eax, dword ptr [rbp + 4*rcx - 240]
	xor	eax, dword ptr [rbp + 4*rdx - 212]
	mov	dword ptr [rbp + 4*rcx - 224], eax
	jmp	LBB1_5
LBB1_3:                                 
	lea	r15, [rbp + 4*rcx - 228]
	mov	ebx, ecx
	shr	ebx, 2
	xor	r14d, r14d
LBB1_4:                                 
                                        
	mov	r13b, byte ptr [r12 + r14 - 16]
	mov	rdi, r15
	mov	esi, ebx
	call	_g
...
LBB1_7:                                 
	movaps	xmm0, xmmword ptr [rbp + 4*rcx - 224]
...
LBB6_1:                                 
	mov	rdi, r13
	call	_mixColumns
	movups	xmm0, xmmword ptr [r15 + rbx]
