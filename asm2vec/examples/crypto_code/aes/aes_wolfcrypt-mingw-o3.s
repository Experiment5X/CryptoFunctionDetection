...
L7:
	...
	mov	DWORD PTR [esp+24], OFFSET FLAT:_rcon
...
L59:
	...
	movzx	ebp, BYTE PTR _Te[1024+ebp*4]
	movzx	eax, al
	add	edi, 32
	mov	eax, DWORD PTR _Te[3072+eax*4]
	and	esi, 65280
	and	eax, 16711680
	or	eax, esi
	mov	esi, ebx
...
L9:
	...
	and	edx, 16711680
	xor	edx, eax
	xor	DWORD PTR [esp+20], edx
	mov	eax, DWORD PTR [esp+20]
	xor	DWORD PTR [esp+16], eax
	mov	ebp, DWORD PTR [esp+16]
	mov	DWORD PTR [edi+16], edx
	xor	ebx, ebp
	cmp	esi, OFFSET FLAT:_rcon+28
...
L6:
	...
	mov	edx, eax
	shr	edx, 24
	movzx	edx, BYTE PTR _Te[1024+edx*4]
	and	ecx, 65280
	or	ecx, 16777216
	xor	ecx, DWORD PTR [esi]
	xor	ecx, edx
	...
	and	edx, -16777216
	xor	edx, ebx
	mov	ebx, DWORD PTR _Te[3072+eax*4]
	and	ebx, 16711680
	xor	edx, ebx
	xor	edx, ecx
	mov	DWORD PTR [esi+192], edx
	xor	edx, DWORD PTR [esp+16]
...
L19:
	...
	movzx	ecx, bl
	mov	eax, ebx
	movzx	edi, BYTE PTR _Te[1024+ecx*4]
	mov	ecx, ebx
	shr	eax, 24
	shr	ecx, 16
	movzx	eax, BYTE PTR _Te[1024+eax*4]
	...
	movzx	eax, BYTE PTR _Te[1024+eax*4]
	xor	ecx, DWORD PTR _Td[2048+eax*4]
	mov	eax, ebx
	shr	eax, 24
	movzx	eax, BYTE PTR _Te[1024+eax*4]
...
L83:
	...
	xor	BYTE PTR [eax+248], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+1]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+249], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+2]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+250], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+3]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+251], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+4]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+252], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+5]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+253], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+6]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+254], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+7]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+255], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+8]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+256], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+9]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+257], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+10]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+258], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+11]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+259], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+12]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+260], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+13]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+261], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+14]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+262], dl
	mov	eax, DWORD PTR [esp+56]
	movzx	edx, BYTE PTR [eax+15]
	mov	eax, DWORD PTR [esp+48]
	xor	BYTE PTR [eax+263], dl
...
L71:
	...
	movzx	edi, ah
	mov	ebx, eax
	mov	ebp, DWORD PTR _Te[2048+edi*4]
	shr	ebx, 16
	movzx	ebx, bl
	xor	ebp, esi
	...
	mov	ebx, esi
	shr	ebx, 24
	mov	ebp, DWORD PTR _Te[0+ebx*4]
	xor	ebp, DWORD PTR _Te[3072+ecx*4]
	xor	ebp, DWORD PTR [edi+160]
	mov	edi, DWORD PTR [esp+8]
	movzx	ebx, BYTE PTR [esp]
	mov	ecx, edi
	shr	ecx, 16
	movzx	ecx, cl
	xor	ebp, DWORD PTR _Te[1024+ecx*4]
	movzx	ecx, ah
...
L89:
	...
	je	L90
	mov	eax, DWORD PTR [esp+64]
	movzx	edx, BYTE PTR [eax+248]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx], dl
	movzx	edx, BYTE PTR [eax+249]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+1], dl
	movzx	edx, BYTE PTR [eax+250]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+2], dl
	movzx	edx, BYTE PTR [eax+251]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+3], dl
	movzx	edx, BYTE PTR [eax+252]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+4], dl
	movzx	edx, BYTE PTR [eax+253]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+5], dl
	movzx	edx, BYTE PTR [eax+254]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+6], dl
	movzx	edx, BYTE PTR [eax+255]
	xor	BYTE PTR [ecx+7], dl
	mov	eax, DWORD PTR [esp+64]
	movzx	edx, BYTE PTR [eax+256]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+8], dl
	movzx	edx, BYTE PTR [eax+257]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+9], dl
	movzx	edx, BYTE PTR [eax+258]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+10], dl
	movzx	edx, BYTE PTR [eax+259]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+11], dl
	movzx	edx, BYTE PTR [eax+260]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+12], dl
	movzx	edx, BYTE PTR [eax+261]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+13], dl
	movzx	edx, BYTE PTR [eax+262]
	mov	eax, DWORD PTR [esp+64]
	xor	BYTE PTR [ecx+14], dl
	movzx	edx, BYTE PTR [eax+263]
	xor	BYTE PTR [ecx+15], dl
	mov	eax, DWORD PTR [esp+64]
	add	DWORD PTR [esp+72], 16
	add	DWORD PTR [esp+68], 16
...
L90:
	...
	mov	edx, DWORD PTR [esp+16]
	add	DWORD PTR [esp+72], 16
	xor	edx, DWORD PTR [eax+248]
	mov	eax, DWORD PTR [esp+68]
	mov	DWORD PTR [eax], edx
	mov	eax, DWORD PTR [esp+64]
	xor	esi, DWORD PTR [eax+252]
	mov	eax, DWORD PTR [esp+68]
	mov	DWORD PTR [eax+4], esi
	mov	eax, DWORD PTR [esp+64]
	xor	ebx, DWORD PTR [eax+256]
	mov	eax, DWORD PTR [esp+68]
	mov	DWORD PTR [eax+8], ebx
	mov	eax, DWORD PTR [esp+64]
	xor	edi, DWORD PTR [eax+260]
	mov	eax, DWORD PTR [esp+68]
	add	DWORD PTR [esp+68], 16
