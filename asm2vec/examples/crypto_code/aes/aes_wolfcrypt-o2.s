...
LBB0_19:                                
	...
	mov	ebx, dword ptr [r15 + 8*rax + 28]
	mov	rcx, rbx
	shr	rcx, 14
	and	ecx, 1020
	movzx	ecx, byte ptr [rcx + r14 + 2051]
	shl	ecx, 24
	movzx	edx, bh
	movzx	edx, byte ptr [r14 + 4*rdx + 3074]
	shl	edx, 16
	xor	edx, esi
	xor	edx, ecx
	movzx	ecx, bl
	movzx	ecx, byte ptr [r14 + 4*rcx + 1]
	shl	ecx, 8
	mov	r12, rbx
	shr	rbx, 24
	movzx	esi, byte ptr [r14 + 4*rbx + 1024]
	xor	esi, ecx
	xor	esi, edx
	xor	esi, dword ptr [rax + r8]
	movzx	edx, byte ptr [r15 + 8*rax + 31]
	...
	mov	ebx, ecx
	shr	ebx, 24
	movzx	ebx, byte ptr [r14 + 4*rbx + 2051]
	shl	ebx, 24
	...
	shl	edx, 16
	movzx	edi, ch
	movzx	edi, byte ptr [r14 + 4*rdi + 1]
	shl	edi, 8
	xor	edi, edx
	movzx	ecx, cl
	movzx	ecx, byte ptr [r14 + 4*rcx + 1024]
	xor	ecx, edi
	xor	ecx, ebx
...
LBB0_21:
	...
	.p2align	4, 0x90
LBB0_22:                                
	movzx	r11d, byte ptr [r15 + 4*rax + 12]
	movzx	r10d, byte ptr [r15 + 4*rax + 13]
	movzx	r8d, byte ptr [r15 + 4*rax + 14]
	mov	ebx, dword ptr [r15 + 4*rax + 12]
	mov	rdx, rbx
	shr	rdx, 14
	and	edx, 1020
	movzx	edx, byte ptr [rdx + r14 + 2051]
	shl	edx, 24
	movzx	edi, bh
	movzx	edi, byte ptr [r14 + 4*rdi + 3074]
	shl	edi, 16
	xor	edi, esi
	xor	edi, edx
	movzx	edx, bl
	...
	mov	rcx, rbx
	shr	rcx, 24
	movzx	esi, byte ptr [r14 + 4*rcx + 1024]
	xor	esi, edx
	xor	esi, edi
	xor	esi, dword ptr [rax + r9]
	movzx	edx, byte ptr [r15 + 4*rax + 15]
	mov	dword ptr [r15 + 4*rax + 16], esi
	mov	ecx, dword ptr [r15 + 4*rax + 4]
	xor	ecx, esi
	mov	dword ptr [r15 + 4*rax + 20], ecx
	xor	ecx, dword ptr [r15 + 4*rax + 8]
	mov	dword ptr [r15 + 4*rax + 24], ecx
	xor	ecx, ebx
	mov	dword ptr [r15 + 4*rax + 28], ecx
	add	rax, 4
	cmp	rax, 40
	jne	LBB0_22
...
LBB0_33:                                
	...
	mov	dword ptr [r15 + 4*rsi], edx
	movzx	r9d, byte ptr [r15 + 4*rcx + 12]
	movzx	r10d, byte ptr [r15 + 4*rcx + 13]
	movzx	edi, byte ptr [r15 + 4*rcx + 14]
	movzx	r8d, byte ptr [r15 + 4*rcx + 15]
	mov	ebx, dword ptr [r15 + 4*rcx + 12]
	lea	edx, [rax + 3]
	mov	esi, dword ptr [r15 + 4*rdx]
	mov	dword ptr [r15 + 4*rcx + 12], esi
	mov	dword ptr [r15 + 4*rdx], ebx
	add	rcx, 4
	add	eax, -4
	cmp	rcx, rax
	jb	LBB0_33
