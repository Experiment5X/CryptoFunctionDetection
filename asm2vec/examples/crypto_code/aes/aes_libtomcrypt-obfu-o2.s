...
.LBB0_134:                              
	...
	jmp	.LBB0_1
.LBB0_150:                              
	mov	edi, dword ptr [4*r12 + Te4_3]
	mov	eax, dword ptr [4*r15 + Te4_2]
	mov	ecx, eax
	not	ecx
	and	ecx, -1302131939
	and	eax, 1302131938
...
.LBB0_101:                              
	...
	jmp	.LBB0_103
.LBB0_104:                              
	mov	eax, dword ptr [4*r12 + Te4_3]
	mov	esi, dword ptr [4*rdi + Te4_2]
	mov	ebx, esi
	not	ebx
	and	ebx, -1481888616
	and	esi, 1481888615
...
.LBB1_46:                               
	...
	mov	eax, dword ptr [rsp + 12]
	shr	eax, 24
	mov	ecx, dword ptr [4*rax + Te4_3]
	mov	eax, dword ptr [rsp + 16]
	shr	eax, 16
	mov	edx, eax
	xor	edx, 65280
	and	edx, eax
	mov	eax, dword ptr [4*rdx + Te4_2]
	mov	edx, eax
	not	edx
	and	edx, ecx
	not	ecx
...
.LBB2_2:                                
	...
	and	eax, -900039254
	or	eax, ebp
	mov	r12d, dword ptr [rcx + 240]
	mov	r9d, dword ptr [rcx + 244]
	mov	ebp, r12d
	not	ebp
	and	ebp, 900039253
	and	r12d, -900039254
...
.LBB2_37:                               
	...
	mov	eax, dword ptr [rsp + 16]
	shr	eax, 24
	mov	ebx, dword ptr [4*rax + TD0]
	mov	eax, dword ptr [rsp + 4]
	shr	eax, 16
	movzx	eax, al
	mov	ebp, dword ptr [4*rax + TD1]
	mov	eax, ebp
	not	eax
	and	eax, -1383583393
	and	ebp, 1383583392
