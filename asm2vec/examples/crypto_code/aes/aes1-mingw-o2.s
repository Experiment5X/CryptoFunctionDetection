...
L40:
	...
	add	ecx, 4
	mov	edx, eax
	xor	dl, BYTE PTR [ecx-2]
	xor	dl, BYTE PTR _mul2[ebx]
	xor	dl, BYTE PTR _mul_3[edi]
	mov	BYTE PTR [ebp-4], dl
	mov	edx, eax
	xor	dl, BYTE PTR [ecx-4]
	xor	dl, BYTE PTR _mul2[edi]
	xor	dl, BYTE PTR _mul_3[esi]
	mov	BYTE PTR [ebp-3], dl
	movzx	edx, BYTE PTR [ecx-4]
	xor	dl, BYTE PTR [ecx-3]
	xor	dl, BYTE PTR _mul2[esi]
	xor	dl, BYTE PTR _mul_3[eax]
	mov	BYTE PTR [ebp-2], dl
	movzx	edx, BYTE PTR [ecx-3]
	xor	dl, BYTE PTR [ecx-2]
	xor	dl, BYTE PTR _mul_3[ebx]
	xor	dl, BYTE PTR _mul2[eax]
