...
L50:
	...
	mov	DWORD PTR [esp+28], OFFSET FLAT:_rcon+4
...
L73:
	...
	movzx	eax, cl
	shr	ebp, 24
	mov	eax, DWORD PTR _Te4_1[0+eax*4]
	xor	eax, DWORD PTR _Te4_0[0+ebp*4]
	mov	ebp, ecx
	movzx	ecx, ch
	shr	ebp, 16
	...
	mov	ebx, ebp
	movzx	ebp, bl
	xor	eax, DWORD PTR _Te4_3[0+ebp*4]
...
L54:
	...
	mov	ebx, ebp
	movzx	ebp, bl
	mov	ebx, OFFSET FLAT:_rcon+28
	xor	ecx, DWORD PTR _Te4_3[0+ebp*4]
	movzx	ebp, dh
	xor	ecx, DWORD PTR _Te4_2[0+ebp*4]
	xor	ecx, edi
	xor	ecx, eax
	xor	DWORD PTR [esp+16], ecx
	mov	eax, DWORD PTR [esp+16]
...
L51:
	...
	lea	edx, [eax+96+esi*4]
	lea	ecx, [eax+240]
	mov	esi, DWORD PTR [esp+76]
	mov	eax, DWORD PTR [edx]
	cmp	DWORD PTR [esi+480], 1
...
L72:
	...
	mov	DWORD PTR [esp+24], ebx
	mov	DWORD PTR [esp+20], ecx
	mov	DWORD PTR [esp+16], 16777216
	mov	ecx, DWORD PTR [esp+76]
	bswap	eax
	mov	DWORD PTR [esp+28], edx
	mov	DWORD PTR [ebp+16], eax
	mov	eax, DWORD PTR [esi+20]
	mov	esi, OFFSET FLAT:_rcon+4
	bswap	eax
	mov	DWORD PTR [ebp+20], eax
	mov	ebx, eax
	mov	ebp, edi
...
L53:
	...
	shr	edi, 24
	mov	eax, DWORD PTR _Te4_1[0+eax*4]
	xor	eax, DWORD PTR _Te4_0[0+edi*4]
	mov	edi, ebx
	shr	edi, 16
	mov	edx, edi
	movzx	edi, dl
	mov	edx, DWORD PTR [esp+28]
	xor	eax, DWORD PTR _Te4_3[0+edi*4]
	movzx	edi, bh
	xor	eax, DWORD PTR _Te4_2[0+edi*4]
	xor	eax, ebp
	xor	eax, DWORD PTR [esp+16]
	xor	edx, eax
	mov	DWORD PTR [ecx+24], eax
	mov	eax, OFFSET FLAT:_rcon+32
	mov	DWORD PTR [ecx+28], edx
	xor	edx, DWORD PTR [esp+20]
...
L49:
	...
	movzx	ebp, bh
	xor	edx, DWORD PTR _Te4_2[0+ebp*4]
	xor	edx, edi
	xor	eax, edx
	mov	DWORD PTR [ecx+16], eax
	xor	eax, DWORD PTR [esp+16]
...
_rijndael_test:
	...
	lea	ebp, [esp+80]
	lea	ebx, [esp+48]
	mov	DWORD PTR [esp+40], OFFSET FLAT:_tests.7644+4
