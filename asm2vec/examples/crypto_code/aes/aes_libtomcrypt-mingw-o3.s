...
L16:
	...
	xor	eax, DWORD PTR _TE3[0+ebx*4]
	mov	ebx, ebp
	shr	ebx, 16
	xor	eax, DWORD PTR [edi]
	movzx	ebx, bl
	xor	eax, DWORD PTR _TE1[0+ebx*4]
	movzx	ebx, ch
	xor	eax, DWORD PTR _TE2[0+ebx*4]
	mov	ebx, ebp
	movzx	ebp, BYTE PTR [esp+24]
	shr	ebx, 24
	mov	ebx, DWORD PTR _TE0[0+ebx*4]
	xor	ebx, DWORD PTR _TE3[0+esi*4]
	mov	esi, ecx
	shr	esi, 16
	...
	mov	eax, esi
	movzx	esi, al
	xor	ebx, DWORD PTR _TE1[0+esi*4]
	movzx	esi, dh
	xor	ebx, DWORD PTR _TE2[0+esi*4]
	mov	esi, ecx
	movzx	ecx, cl
	shr	esi, 24
	mov	esi, DWORD PTR _TE0[0+esi*4]
	xor	esi, DWORD PTR _TE3[0+ebp*4]
	mov	ebp, edx
	shr	ebp, 16
	...
	xor	edx, DWORD PTR [edi+12]
	xor	esi, DWORD PTR _TE1[0+ebp*4]
	mov	ecx, eax
	movzx	ebp, ah
	mov	eax, DWORD PTR [esp+24]
	shr	ecx, 16
	xor	esi, DWORD PTR _TE2[0+ebp*4]
	movzx	ecx, cl
	xor	edx, DWORD PTR _TE1[0+ecx*4]
	movzx	ecx, ah
	xor	edx, DWORD PTR _TE2[0+ecx*4]
L8:
	...
	xor	ecx, DWORD PTR _TE3[0+ebp*4]
	mov	ebp, ebx
	shr	ebp, 16
	...
	movzx	ebp, al
	mov	eax, esi
	xor	ecx, DWORD PTR _TE1[0+ebp*4]
	movzx	ebp, ah
	mov	eax, ebx
	xor	ecx, DWORD PTR _TE2[0+ebp*4]
	movzx	ebp, BYTE PTR [esp+16]
	shr	eax, 24
	mov	DWORD PTR [esp+20], ecx
	mov	ecx, DWORD PTR _TE0[0+eax*4]
	xor	ecx, DWORD PTR _TE3[0+ebp*4]
	mov	ebp, esi
	shr	ebp, 16
	...
	mov	eax, DWORD PTR [esp+16]
	xor	ecx, DWORD PTR _TE2[0+ebp*4]
	xor	edx, DWORD PTR _TE3[0+esi*4]
	...
	mov	eax, ebp
	shr	eax, 24
	mov	eax, DWORD PTR _Te4_3[0+eax*4]
	xor	eax, DWORD PTR _Te4_0[0+ebx*4]
	mov	ebx, esi
	shr	ebx, 16
	xor	eax, DWORD PTR [edi]
	movzx	ebx, bl
	xor	eax, DWORD PTR _Te4_2[0+ebx*4]
	movzx	ebx, ch
	xor	eax, DWORD PTR _Te4_1[0+ebx*4]
...
L29:
	...
	bswap	esi
	bswap	ebx
	xor	esi, DWORD PTR [ebp+240]
	xor	ebx, DWORD PTR [ebp+244]
	add	eax, edi
	bswap	edx
	bswap	ecx
	xor	edx, DWORD PTR [ebp+248]
	xor	ecx, DWORD PTR [ebp+252]
...
L30:
	...
	movzx	edx, dl
	shr	ebx, 24
	mov	ebx, DWORD PTR _TD0[0+ebx*4]
	xor	ebx, DWORD PTR _TD3[0+edx*4]
	mov	edx, ecx
	shr	edx, 16
	xor	ebx, DWORD PTR [edi]
	movzx	edx, dl
	xor	ebx, DWORD PTR _TD1[0+edx*4]
	movzx	edx, ah
	xor	ebx, DWORD PTR _TD2[0+edx*4]
	movzx	edx, al
	mov	DWORD PTR [esp+24], ebx
	mov	ebx, esi
	shr	esi, 24
	mov	esi, DWORD PTR _TD0[0+esi*4]
	xor	esi, DWORD PTR _TD3[0+edx*4]
	mov	edx, ebp
	shr	edx, 16
	xor	esi, DWORD PTR [edi+4]
	movzx	ebp, cl
	movzx	edx, dl
	xor	esi, DWORD PTR _TD1[0+edx*4]
	movzx	edx, ch
	shr	ecx, 24
	xor	esi, DWORD PTR _TD2[0+edx*4]
	mov	edx, eax
	mov	ecx, DWORD PTR _TD0[0+ecx*4]
	shr	edx, 24
	shr	eax, 16
	mov	edx, DWORD PTR _TD0[0+edx*4]
	xor	edx, DWORD PTR _TD3[0+ebp*4]
	mov	ebp, ebx
	shr	ebp, 16
	...
	xor	edx, DWORD PTR _TD1[0+ebp*4]
	movzx	ebp, bh
	xor	edx, DWORD PTR _TD2[0+ebp*4]
	movzx	ebp, bl
	xor	ecx, DWORD PTR _TD3[0+ebp*4]
	xor	ecx, DWORD PTR [edi+12]
...
L23:
	...
	shr	ebx, 16
	shr	ebp, 24
	mov	ebp, DWORD PTR _TD0[0+ebp*4]
	xor	ebp, DWORD PTR _TD3[0+eax*4]
	mov	eax, ecx
	shr	eax, 16
	xor	ebp, DWORD PTR [edi-16]
	movzx	eax, al
	xor	ebp, DWORD PTR _TD1[0+eax*4]
	movzx	eax, dh
	xor	ebp, DWORD PTR _TD2[0+eax*4]
	mov	eax, esi
	shr	eax, 24
	mov	eax, DWORD PTR _TD0[0+eax*4]
	mov	DWORD PTR [esp+16], ebp
	movzx	ebp, dl
	xor	eax, DWORD PTR _TD3[0+ebp*4]
	movzx	ebp, bl
	mov	ebx, esi
	xor	eax, DWORD PTR [edi-12]
	shr	ebx, 16
	xor	eax, DWORD PTR _TD1[0+ebp*4]
	movzx	ebp, ch
	xor	eax, DWORD PTR _TD2[0+ebp*4]
	movzx	ebp, cl
	shr	ecx, 24
	mov	ecx, DWORD PTR _TD0[0+ecx*4]
	...
	movzx	ebp, bh
	movzx	ebx, bl
	xor	ecx, DWORD PTR _TD3[0+ebx*4]
	xor	eax, DWORD PTR _TD2[0+ebp*4]
	xor	ecx, DWORD PTR [edi-4]
	xor	ecx, DWORD PTR _TD1[0+edx*4]
	mov	edx, esi
	movzx	esi, dh
	xor	ecx, DWORD PTR _TD2[0+esi*4]
	cmp	edi, DWORD PTR [esp+28]
	jne	L30
	mov	ebp, DWORD PTR [esp+20]
	mov	ebx, ebp
	movzx	edx, bl
	movzx	ebx, ah
	movzx	esi, BYTE PTR _Td4[0+edx*4]
	xor	esi, DWORD PTR [edi]
	mov	edx, esi
	mov	esi, DWORD PTR _Td4[0+ebx*4]
	mov	ebx, DWORD PTR [esp+16]
	and	esi, 65280
	shr	ebx, 24
	xor	esi, edx
	...
	movzx	eax, al
	and	esi, 65280
	mov	eax, DWORD PTR _Td4[0+eax*4]
	xor	esi, edx
	mov	edx, ebp
	...
	movzx	edx, BYTE PTR _Td4[0+ebp*4]
	xor	ebx, edx
...
L72:
	...
	xor	edx, DWORD PTR _Te4_0[0+ebp*4]
	mov	ebp, ecx
	movzx	ecx, ch
	xor	edx, DWORD PTR [esi-32]
	shr	ebp, 16
	mov	DWORD PTR [esp+28], edx
	mov	edx, ebp
	movzx	ebp, dl
	mov	edx, DWORD PTR [esp+28]
	xor	edx, DWORD PTR _Te4_3[0+ebp*4]
	xor	edx, DWORD PTR _Te4_2[0+ecx*4]
	mov	DWORD PTR [esi], edx
	xor	edx, DWORD PTR [esi-28]
...
L52:
	...
	add	edi, 4
	movzx	edx, bl
	xor	eax, DWORD PTR _Te4_1[0+edx*4]
	mov	edx, ebx
	shr	edx, 24
	xor	eax, DWORD PTR _Te4_0[0+edx*4]
	mov	edx, ebx
	shr	edx, 16
	movzx	edx, dl
	xor	eax, DWORD PTR _Te4_3[0+edx*4]
	movzx	edx, bh
	xor	eax, DWORD PTR _Te4_2[0+edx*4]
	xor	DWORD PTR [esp+24], eax
	mov	ecx, DWORD PTR [esp+24]
	xor	DWORD PTR [esp+20], ecx
	mov	edx, DWORD PTR [esp+20]
	xor	DWORD PTR [esp+16], edx
	cmp	edi, OFFSET FLAT:_rcon+28
...
L71:
	...
	movzx	esi, al
	mov	DWORD PTR [edx+20], eax
	xor	ecx, DWORD PTR _Te4_1[0+esi*4]
	mov	esi, eax
	shr	esi, 24
	xor	ecx, DWORD PTR _Te4_0[0+esi*4]
	mov	esi, eax
	shr	esi, 16
	...
	movzx	esi, cl
	mov	ecx, DWORD PTR [esp+16]
	xor	ecx, DWORD PTR _Te4_3[0+esi*4]
	movzx	esi, ah
	xor	ecx, DWORD PTR _Te4_2[0+esi*4]
	...
	shr	ebp, 24
	mov	esi, DWORD PTR _Te4_1[0+esi*4]
	xor	esi, DWORD PTR _Te4_0[0+ebp*4]
	mov	ebp, eax
	shr	ebp, 16
	mov	ecx, ebp
	movzx	ebp, cl
	mov	ecx, DWORD PTR [esp+24]
	xor	esi, 33554432
	xor	esi, DWORD PTR _Te4_3[0+ebp*4]
	movzx	ebp, ah
	xor	esi, DWORD PTR _Te4_2[0+ebp*4]
	mov	ebp, edi
	mov	edi, DWORD PTR [esp+20]
	xor	esi, DWORD PTR [esp+16]
	xor	ebx, esi
	...
	shr	edi, 24
	mov	ecx, DWORD PTR _Te4_1[0+ecx*4]
	xor	ecx, DWORD PTR _Te4_0[0+edi*4]
	mov	edi, eax
	shr	edi, 16
	xor	ecx, 67108864
	mov	DWORD PTR [esp+24], ecx
	...
	movzx	edi, cl
	mov	ecx, DWORD PTR [esp+24]
	xor	ecx, DWORD PTR _Te4_3[0+edi*4]
	movzx	edi, ah
	xor	ecx, DWORD PTR _Te4_2[0+edi*4]
	...
	shr	edi, 24
	mov	esi, DWORD PTR _Te4_1[0+esi*4]
	xor	esi, DWORD PTR _Te4_0[0+edi*4]
	mov	edi, eax
	shr	edi, 16
	mov	ecx, edi
	movzx	edi, cl
	mov	ecx, DWORD PTR [esp+20]
	xor	esi, 134217728
	xor	esi, DWORD PTR _Te4_3[0+edi*4]
	movzx	edi, ah
	xor	esi, DWORD PTR _Te4_2[0+edi*4]
	mov	edi, DWORD PTR [esp+16]
	...
	xor	edi, ebp
	mov	DWORD PTR [edx+104], ebp
	xor	ecx, edi
	mov	DWORD PTR [edx+108], edi
	mov	DWORD PTR [esp+16], edi
	xor	eax, ecx
	...
	mov	ecx, DWORD PTR [esp+20]
	xor	ebp, ebx
	mov	DWORD PTR [edx+124], ebx
	xor	edi, ebp
	mov	DWORD PTR [edx+128], ebp
	mov	DWORD PTR [esp+16], edi
	mov	DWORD PTR [edx+132], edi
	xor	ecx, edi
	xor	eax, ecx
	mov	DWORD PTR [esp+20], ecx
	...
	xor	esi, DWORD PTR [esp+24]
	xor	ebx, esi
	mov	DWORD PTR [edx+144], esi
	xor	ebp, ebx
	mov	DWORD PTR [edx+148], ebx
	xor	edi, ebp
	mov	DWORD PTR [edx+152], ebp
	xor	ecx, edi
	mov	DWORD PTR [edx+156], edi
	mov	DWORD PTR [esp+16], edi
	xor	eax, ecx
	...
	mov	ecx, DWORD PTR [esp+20]
	mov	esi, ebp
	mov	DWORD PTR [edx+176], ebp
	xor	ebx, ebp
	xor	ecx, ebx
	mov	DWORD PTR [edx+180], ebx
	xor	eax, ecx
	...
	shr	ebp, 24
	mov	ecx, DWORD PTR _Te4_1[0+ecx*4]
	xor	ecx, DWORD PTR _Te4_0[0+ebp*4]
	mov	ebp, eax
	movzx	eax, ah
	shr	ebp, 16
	add	ecx, -2147483648
	...
	movzx	ebp, cl
	mov	ecx, DWORD PTR [esp+16]
	xor	ecx, DWORD PTR _Te4_3[0+ebp*4]
	xor	ecx, DWORD PTR _Te4_2[0+eax*4]
	xor	ecx, DWORD PTR [esp+24]
	xor	edi, ecx
	mov	DWORD PTR [edx+192], ecx
	xor	esi, edi
	mov	DWORD PTR [edx+196], edi
	mov	DWORD PTR [edx+200], esi
	xor	esi, ebx
	mov	DWORD PTR [edx+204], esi
L49:
	mov	eax, DWORD PTR [esp+68]
	cmp	DWORD PTR [edx+480], 1
	lea	ebx, [edx+240]
	lea	ecx, [edx+96+eax*4]
...
L54:
	...
	movzx	edi, dl
	shr	eax, 24
	mov	eax, DWORD PTR _Tks0[0+eax*4]
	xor	eax, DWORD PTR _Tks3[0+edi*4]
	mov	edi, ebp
	shr	edi, 16
	mov	edx, edi
	movzx	edi, dl
	xor	eax, DWORD PTR _Tks1[0+edi*4]
	mov	edi, eax
	mov	eax, ebp
	movzx	eax, ah
	xor	edi, DWORD PTR _Tks2[0+eax*4]
...
L70:
	...
	shr	ecx, 24
	xor	eax, 16777216
	xor	eax, DWORD PTR _Te4_1[0+esi*4]
	xor	eax, DWORD PTR _Te4_0[0+ecx*4]
	mov	ecx, ebp
	shr	ecx, 16
	movzx	ecx, cl
	xor	eax, DWORD PTR _Te4_3[0+ecx*4]
	mov	ecx, ebp
	movzx	ecx, ch
	xor	eax, DWORD PTR _Te4_2[0+ecx*4]
	mov	ecx, ebp
	xor	ebx, eax
	mov	DWORD PTR [edx+16], eax
	xor	eax, 33554432
	...
	mov	esi, ecx
	shr	esi, 24
	xor	eax, DWORD PTR _Te4_0[0+esi*4]
	mov	esi, ecx
	shr	esi, 16
	mov	ebp, eax
	mov	eax, esi
	movzx	esi, al
	mov	eax, DWORD PTR _Te4_3[0+esi*4]
	movzx	esi, ch
	xor	eax, ebp
	xor	eax, DWORD PTR _Te4_2[0+esi*4]
	xor	ebx, eax
	...
	xor	eax, 452984832
	xor	edi, ebx
	mov	DWORD PTR [edx+132], ebx
	xor	ecx, edi
	mov	DWORD PTR [edx+136], edi
	movzx	esi, cl
...
_rijndael_test:
	...
	push	ebx
	call	___chkstk_ms
	mov	ebp, OFFSET FLAT:_tests.7644+4
	sub	esp, eax
	lea	edi, [esp+80]
	lea	ebx, [esp+48]
...
L78:
	...
	jne	L76
	cmp	BYTE PTR [esp+53], 0
	jne	L76
	cmp	BYTE PTR [esp+54], 0
	jne	L76
	cmp	BYTE PTR [esp+55], 0
	jne	L76
	cmp	BYTE PTR [esp+56], 0
	jne	L76
	cmp	BYTE PTR [esp+57], 0
	jne	L76
	cmp	BYTE PTR [esp+58], 0
	jne	L76
	cmp	BYTE PTR [esp+59], 0
	jne	L76
	cmp	BYTE PTR [esp+60], 0
	jne	L76
	cmp	BYTE PTR [esp+61], 0
	jne	L76
	cmp	BYTE PTR [esp+62], 0
	jne	L76
