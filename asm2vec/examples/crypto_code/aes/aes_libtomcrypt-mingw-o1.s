...
L44:
	...
	xor	edx, DWORD PTR _TE3[0+ebx*4]
	...
	mov	ebx, esi
	movzx	esi, bh
	xor	edx, DWORD PTR _TE2[0+esi*4]
	add	edi, 32
	...
	mov	esi, ebp
	shr	esi, 24
	movzx	ebx, BYTE PTR [esp+36]
	mov	esi, DWORD PTR _TE0[0+esi*4]
	xor	esi, DWORD PTR _TE3[0+ebx*4]
	xor	esi, DWORD PTR [edi+4]
	mov	ebx, ecx
	shr	ebx, 16
	movzx	ebx, bl
	xor	esi, DWORD PTR _TE1[0+ebx*4]
	movzx	ebx, dh
	xor	esi, DWORD PTR _TE2[0+ebx*4]
	mov	ebx, ecx
	shr	ebx, 24
	movzx	ebp, BYTE PTR [esp+28]
	mov	ebx, DWORD PTR _TE0[0+ebx*4]
	xor	ebx, DWORD PTR _TE3[0+ebp*4]
	xor	ebx, DWORD PTR [edi+8]
	mov	ebp, edx
	shr	ebp, 16
	mov	eax, ebp
	movzx	ebp, al
	xor	ebx, DWORD PTR _TE1[0+ebp*4]
	mov	eax, DWORD PTR [esp+36]
	movzx	ebp, ah
	xor	ebx, DWORD PTR _TE2[0+ebp*4]
	shr	edx, 24
	movzx	ecx, cl
	mov	edx, DWORD PTR _TE0[0+edx*4]
...
L57:
	...
	xor	ecx, DWORD PTR _TD3[0+esi*4]
	xor	ecx, DWORD PTR [edi+28]
	shr	edx, 16
	movzx	edx, dl
	xor	ecx, DWORD PTR _TD1[0+edx*4]
	mov	ebx, DWORD PTR [esp+24]
	movzx	ebx, bh
	xor	ecx, DWORD PTR _TD2[0+ebx*4]
	add	edi, 32
	...
	mov	edx, ebp
	movzx	edx, dl
	mov	esi, DWORD PTR _TD0[0+ebx*4]
...
L56:
	...
	mov	ebp, eax
	shr	ebp, 24
	mov	ebx, DWORD PTR _Td4[0+ebp*4]
	and	ebx, -16777216
	or	edx, ebx
	xor	edx, esi
	mov	esi, edx
...
_rijndael_test:
	...
	call	___chkstk_ms
	sub	esp, eax
	mov	DWORD PTR [esp+44], OFFSET FLAT:_tests.7644+4
