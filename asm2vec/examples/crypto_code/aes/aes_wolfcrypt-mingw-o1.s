...
L17:
	...
	shr	eax, 16
	movzx	eax, al
	mov	eax, DWORD PTR _Te[2048+eax*4]
	and	eax, -16777216
	xor	eax, ecx
	movzx	ecx, dh
...
L26:
	...
	movzx	eax, BYTE PTR _Te[1024+eax*4]
	movzx	esi, cl
	movzx	ebp, BYTE PTR _Te[1024+esi*4]
...
L48:
	...
	mov	ebx, edi
	movzx	ebx, bl
	mov	esi, DWORD PTR _Te[3072+ebx*4]
	and	esi, 16711680
	mov	edi, eax
	shr	edi, 24
	mov	ebx, DWORD PTR _Te[2048+edi*4]
	and	ebx, -16777216
	or	esi, ebx
	xor	edx, esi
...
L46:
	...
	movzx	edx, dl
	mov	esi, DWORD PTR _Te[0+esi*4]
	xor	esi, DWORD PTR _Te[3072+edx*4]
	mov	edx, DWORD PTR [esp+52]
	xor	esi, DWORD PTR [edx+32]
	mov	edx, ecx
	shr	edx, 16
	movzx	edx, dl
	xor	esi, DWORD PTR _Te[1024+edx*4]
	movzx	edx, bh
	xor	esi, DWORD PTR _Te[2048+edx*4]
	mov	DWORD PTR [esp+8], esi
	mov	edx, ecx
	shr	edx, 24
	...
	shr	eax, 24
	movzx	ebx, dl
	mov	ecx, DWORD PTR _Te[0+eax*4]
	xor	ecx, DWORD PTR _Te[3072+ebx*4]
	mov	eax, DWORD PTR [esp+52]
	xor	ecx, DWORD PTR [eax+116]
	mov	ebx, esi
	shr	ebx, 16
	movzx	ebx, bl
	xor	ecx, DWORD PTR _Te[1024+ebx*4]
	...
	shr	eax, 24
	movzx	esi, BYTE PTR [esp+4]
	mov	edx, DWORD PTR _Te[0+eax*4]
	xor	edx, DWORD PTR _Te[3072+esi*4]
	mov	esi, DWORD PTR [esp+52]
	xor	edx, DWORD PTR [esi+132]
	mov	esi, ebx
	shr	esi, 16
	mov	eax, esi
	movzx	esi, al
	...
	shr	edi, 24
	movzx	ebp, bl
	mov	ebx, DWORD PTR _Te[0+edi*4]
	xor	ebx, DWORD PTR _Te[3072+ebp*4]
	mov	edi, DWORD PTR [esp+52]
	xor	ebx, DWORD PTR [edi+140]
	shr	eax, 16
	movzx	edi, al
	xor	ebx, DWORD PTR _Te[1024+edi*4]
	movzx	ecx, ch
	...
	mov	ebx, DWORD PTR _Te[0+eax*4]
	xor	ebx, DWORD PTR _Te[3072+edi*4]
	mov	edi, DWORD PTR [esp+52]
	xor	ebx, DWORD PTR [edi+148]
	mov	edi, esi
	shr	edi, 16
	mov	eax, edi
	movzx	edi, al
	...
	movzx	edx, bl
	mov	ebx, DWORD PTR _Te[0+ecx*4]
	xor	ebx, DWORD PTR _Te[3072+edx*4]
	mov	edx, DWORD PTR [esp+52]
	xor	ebx, DWORD PTR [edx+168]
	mov	ecx, eax
	shr	ecx, 16
	movzx	edx, cl
	xor	ebx, DWORD PTR _Te[1024+edx*4]
	mov	eax, esi
	movzx	edx, ah
	xor	ebx, DWORD PTR _Te[2048+edx*4]
	mov	esi, ebx
	mov	ecx, DWORD PTR [esp+4]
	shr	ecx, 24
	mov	edx, edi
	movzx	ebx, dl
	mov	edx, DWORD PTR _Te[0+ecx*4]
	xor	edx, DWORD PTR _Te[3072+ebx*4]
	mov	edi, DWORD PTR [esp+52]
	xor	edx, DWORD PTR [edi+172]
	mov	ecx, eax
	shr	ecx, 16
	movzx	ecx, cl
	xor	edx, DWORD PTR _Te[1024+ecx*4]
	mov	ebx, ebp
	movzx	ebx, bh
	xor	edx, DWORD PTR _Te[2048+ebx*4]
	mov	eax, DWORD PTR [esp]
	mov	ebx, eax
	shr	ebx, 24
	movzx	ecx, dl
	...
	movzx	ecx, dh
	mov	ebp, ebx
	xor	ebp, DWORD PTR _Te[2048+ecx*4]
	mov	ebx, esi
	shr	ebx, 24
	...
	mov	ebx, esi
	movzx	ebx, bl
	mov	ecx, DWORD PTR _Te[0+edx*4]
	xor	ecx, DWORD PTR _Te[3072+ebx*4]
	mov	edx, DWORD PTR [esp+52]
	xor	ecx, DWORD PTR [edx+188]
	shr	eax, 16
	movzx	edx, al
	xor	ecx, DWORD PTR _Te[1024+edx*4]
	mov	eax, DWORD PTR [esp+8]
	movzx	edx, ah
	xor	ecx, DWORD PTR _Te[2048+edx*4]
	mov	eax, ecx
	mov	DWORD PTR [esp+4], ecx
	...
	mov	ecx, DWORD PTR _Te[0+esi*4]
	xor	ecx, DWORD PTR _Te[3072+ebx*4]
	mov	esi, DWORD PTR [esp+52]
	xor	ecx, DWORD PTR [esi+220]
	mov	edx, eax
	shr	edx, 16
	movzx	edx, dl
	xor	ecx, DWORD PTR _Te[1024+edx*4]
...
L66:
	...
	mov	eax, edi
	movzx	edx, al
	movzx	ebx, BYTE PTR _Td4[edx]
	xor	ebx, DWORD PTR [ecx+8]
	mov	eax, esi
	shr	eax, 24
	movzx	edx, BYTE PTR _Td4[eax]
	sal	edx, 24
	xor	ebx, edx
	mov	edx, DWORD PTR [esp]
	shr	edx, 16
...
L64:
	...
	mov	eax, DWORD PTR [esp+4]
	movzx	ecx, al
	mov	ebp, DWORD PTR _Td[0+esi*4]
	xor	ebp, DWORD PTR _Td[3072+ecx*4]
	mov	edi, DWORD PTR [esp+48]
	xor	ebp, DWORD PTR [edi+16]
	mov	ecx, ebx
	shr	ecx, 16
	movzx	ecx, cl
	xor	ebp, DWORD PTR _Td[1024+ecx*4]
	movzx	ecx, dh
	xor	ebp, DWORD PTR _Td[2048+ecx*4]
	mov	esi, eax
	shr	esi, 24
	movzx	ecx, dl
	...
	mov	eax, DWORD PTR [esp+48]
	xor	ebx, DWORD PTR [eax+28]
	shr	edx, 16
	movzx	edx, dl
	xor	ebx, DWORD PTR _Td[1024+edx*4]
	mov	edx, DWORD PTR [esp+4]
	movzx	edx, dh
	xor	ebx, DWORD PTR _Td[2048+edx*4]
	mov	esi, ebx
	mov	eax, ebp
	mov	ebx, ebp
	shr	ebx, 24
	mov	edx, edi
	movzx	edx, dl
	mov	ebp, DWORD PTR _Td[0+ebx*4]
	xor	ebp, DWORD PTR _Td[3072+edx*4]
	mov	ebx, DWORD PTR [esp+48]
	xor	ebp, DWORD PTR [ebx+32]
	mov	edx, esi
	shr	edx, 16
	movzx	edx, dl
	xor	ebp, DWORD PTR _Td[1024+edx*4]
	movzx	edx, ch
	xor	ebp, DWORD PTR _Td[2048+edx*4]
	mov	DWORD PTR [esp], ebp
	mov	ebx, edi
	shr	ebx, 24
	movzx	edx, cl
	mov	ebx, DWORD PTR _Td[0+ebx*4]
	xor	ebx, DWORD PTR _Td[3072+edx*4]
	mov	edx, DWORD PTR [esp+48]
	xor	ebx, DWORD PTR [edx+36]
	mov	DWORD PTR [esp+4], eax
	mov	edx, eax
	shr	edx, 16
	movzx	edx, dl
	...
	xor	esi, DWORD PTR _Td[3072+ebp*4]
	mov	eax, DWORD PTR [esp+48]
	...
	mov	ecx, edi
	movzx	edi, ch
	xor	esi, DWORD PTR _Td[2048+edi*4]
	mov	eax, DWORD PTR [esp]
	mov	edi, eax
	shr	edi, 24
	movzx	ecx, bl
	mov	ebp, DWORD PTR _Td[0+edi*4]
	xor	ebp, DWORD PTR _Td[3072+ecx*4]
	mov	edi, DWORD PTR [esp+48]
	xor	ebp, DWORD PTR [edi+48]
	mov	ecx, esi
	shr	ecx, 16
	movzx	ecx, cl
	xor	ebp, DWORD PTR _Td[1024+ecx*4]
	...
	xor	esi, DWORD PTR [eax+144]
	mov	edi, ecx
	shr	edi, 16
	mov	eax, edi
	movzx	edi, al
	xor	esi, DWORD PTR _Td[1024+edi*4]
	movzx	edi, dh
	mov	ebp, esi
	xor	ebp, DWORD PTR _Td[2048+edi*4]
	mov	edi, ebx
	shr	edi, 24
	mov	esi, edi
	movzx	edi, dl
	...
	movzx	ecx, bl
	mov	edx, DWORD PTR _Td[0+edx*4]
	xor	edx, DWORD PTR _Td[3072+ecx*4]
	xor	edx, DWORD PTR [eax+160]
	mov	ecx, edi
	shr	ecx, 16
	movzx	ecx, cl
	xor	edx, DWORD PTR _Td[1024+ecx*4]
	mov	eax, esi
	movzx	ecx, ah
	xor	edx, DWORD PTR _Td[2048+ecx*4]
	mov	DWORD PTR [esp+4], edx
	mov	edx, ebx
	shr	edx, 24
	mov	eax, esi
	...
	mov	edx, edi
	movzx	edx, dl
	mov	esi, DWORD PTR _Td[0+ecx*4]
	xor	esi, DWORD PTR _Td[3072+edx*4]
	mov	ecx, DWORD PTR [esp+48]
	xor	esi, DWORD PTR [ecx+176]
	mov	edx, ebx
	shr	edx, 16
	movzx	edx, dl
	xor	esi, DWORD PTR _Td[1024+edx*4]
